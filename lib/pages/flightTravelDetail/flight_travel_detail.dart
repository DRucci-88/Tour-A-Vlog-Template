...
class FlightTravellarsDetails extends StatefulWidget {
  const FlightTravellarsDetails({Key? key}) : super(key: key);

  @override
  State<FlightTravellarsDetails> createState() =>
      _FlightTravellarsDetailsState();
}

class _FlightTravellarsDetailsState extends State<FlightTravellarsDetails> {
