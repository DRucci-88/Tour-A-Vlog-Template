...
import 'package:touravelog/pages/profile/booking.dart';
import 'package:flutter/material.dart';

import '../../theme/theme.dart';

class HotelBookingOngoning extends StatefulWidget {
  const HotelBookingOngoning({Key? key, this.index}) : super(key: key);

  final int? index;

  @override
  State<HotelBookingOngoning> createState() => _HotelBookingOngoningState();
}

class _HotelBookingOngoningState extends State<HotelBookingOngoning> {
  @override
