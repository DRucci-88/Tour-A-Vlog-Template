...
import 'package:touravelog/widget/column_builder.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final latestCollectionList = [
    ...
    },
    {
      ...
      "name": "Top indoneisa destination for family trip",
      "places": 5,
    },
  ];
  ...
  final internationalDestination = [
    ...
    {
      "image": "assets/home/destination4.png",
      "name": "Bankok",
    },
    {
  ...
  indianDestinationList(Size size) {
    return Column(
      children: [
        Padding(
          padding: const EdgeInsets.symmetric(
          ...
          child: Row(
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  Navigator.pushNamed(context, '/topIndianDestination');
                },
                child: Text(
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Expanded(
                child: Text(
                  getTranslate(context, 'home.international_deationation'),
                  style: semibold16white.copyWith(
                      color: const Color(0xff333333),
                      fontWeight: FontWeight.w600),
                ),
              ...
              InkWell(
                onTap: () {
                  Navigator.pushNamed(context, '/topInternationalDestination');
                },
                child: Text(
                  getTranslate(context, 'home.see_all'),
                  style: medium14primary,
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  Navigator.pushNamed(context, '/latestCollection');
                },
                child: Text(
                  getTranslate(context, 'home.see_all'),
                  style: medium14primary,
